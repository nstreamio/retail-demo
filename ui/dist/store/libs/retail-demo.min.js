...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("@nstream/domain"), require("@swim/util"), require("@swim/model"), require("@swim/client"), require("@swim/graphics"), require("@swim/uri"), require("@swim/controller"), require("@swim/panel"), require("@swim/dom"), require("@swim/view"), require("@nstream/widget"), require("@swim/table"), require("@swim/math"), require("@swim/theme"), require("@swim/component"), require("@swim/structure"), require("@swim/pie"), require("@swim/style"), require("@swim/time"), require("@swim/chart")) : typeof define === "function" && define.amd ? define([ "exports", "@nstream/domain", "@swim/util", "@swim/model", "@swim/client", "@swim/graphics", "@swim/uri", "@swim/controller", "@swim/panel", "@swim/dom", "@swim/view", "@nstream/widget", "@swim/table", "@swim/math", "@swim/theme", "@swim/component", "@swim/structure", "@swim/pie", "@swim/style", "@swim/time", "@swim/chart" ], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, 
  factory((global.swim = global.swim || {}, global.swim.retaildemo = global.swim.retaildemo || {}), global.nstream, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.nstream, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim));
})(this, (function(exports, domain, util, model, client, graphics, uri, controller, panel, dom, view, widget, table, math, theme, component, structure, pie, style, time, chart) {
  "use strict";
  ...
  let OrderStatusPieController = (() => {
    ...
    return _a = class OrderStatusPieController extends _classSuper {
      constructor(orderStatus, headerTitle) {
        ...
        window.setTimeout((() => {
          var _b, _c;
          this.statusDownlink.setNodeUri((_c = (_b = this.nodeUri.value) === null || _b === void 0 ? void 0 : _b.stringValue) !== null && _c !== void 0 ? _c : "");
    ...
    return _a = class OrderController extends _classSuper {
      ...
      _focusedCustomerId_decorators = [ component.Property({
        ...
        didSetValue(newValue, oldValue) {
          var _b;
          if (((_b = this.owner.nodeUri.value) === null || _b === void 0 ? void 0 : _b.stringValue) !== "/store/main") {
            return;
          }
    ...
    return _a = class OrderListController extends _classSuper {
      ...
      _panel_decorators = [ controller.TraitViewRef({
        ...
        initView(panelView) {
          ...
          window.setTimeout((() => {
            var _b, _c;
            this.owner.statusDownlink.setNodeUri((_c = (_b = this.owner.nodeUri.value) === null || _b === void 0 ? void 0 : _b.stringValue) !== null && _c !== void 0 ? _c : "");
