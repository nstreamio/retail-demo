      ...
      _unfulfilledCount_decorators = [ component.Property({
        ...
        didSetValue(newValue = 0, oldValue) {
          ...
          if (newValue > 0 && (oldValue === void 0 || oldValue === 0) && panelView) {
            ...
            (_b = olc.controller) === null || _b === void 0 ? void 0 : _b.panel.insertView(panelView).set({
              unitWidth: 1,
              unitHeight: 1
            });
          } else if (newValue === 0 && (oldValue === void 0 || oldValue > 0) && panelView) {
            (_d = (_c = olc.controller) === null || _c === void 0 ? void 0 : _c.panel.view) === null || _d === void 0 ? void 0 : _d.remove();
