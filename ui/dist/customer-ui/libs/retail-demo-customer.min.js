...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("@swim/panel"), require("@swim/component"), require("@swim/view"), require("@swim/dom"), require("@swim/controller"), require("@swim/client"), require("@swim/uri"), require("@nstream/widget"), require("@swim/table"), require("@swim/theme"), require("@swim/math"), require("@nstream/domain"), require("@swim/button"), require("@swim/graphics")) : typeof define === "function" && define.amd ? define([ "exports", "@swim/panel", "@swim/component", "@swim/view", "@swim/dom", "@swim/controller", "@swim/client", "@swim/uri", "@nstream/widget", "@swim/table", "@swim/theme", "@swim/math", "@nstream/domain", "@swim/button", "@swim/graphics" ], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, 
  factory((global.swim = global.swim || {}, global.swim.retaildemo = global.swim.retaildemo || {}), global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.nstream, global.swim, global.swim, global.swim, global.nstream, global.swim, global.swim));
})(this, (function(exports, panel, component, view, dom, controller, client, uri, widget, table, theme, math, domain, button, graphics) {
  "use strict";
    ...
    return _a = class OrderListController extends _classSuper {
      ...
      _ordersDownlink_decorators = [ client.MapDownlink({
        ...
        didUpdate(nodeUri, value) {
          ...
          const status = (_b = value.get("status").stringValue()) !== null && _b !== void 0 ? _b : "unknown";
          let orderType = OrderType.Unknown;
          if ((_c = value.get("products").get("A").numberValue()) !== null && _c !== void 0 ? _c : 0) {
            orderType = OrderType.OrderA;
          } else if ((_d = value.get("products").get("B").numberValue()) !== null && _d !== void 0 ? _d : 0) {
            orderType = OrderType.OrderB;
          } else if ((_e = value.get("products").get("C").numberValue()) !== null && _e !== void 0 ? _e : 0) {
          ...
          if (status === "pickupCompleted") {
            ...
            const orderTypeCell = orderController.orderTypeCell.attachView();
            orderTypeCell.modifyMood(theme.Feel.default, moodStatus.moodModifier);
            ...
            orderTypeCell.node.firstChild.style.alignSelf = "unset";
            const statusCell = orderController.statusCell.attachView();
            statusCell.set({
              style: {
                height: "40px",
  ...
  let MainController = (() => {
    ...
    let _customerId_decorators;
    let _customerId_initializers = [];
    let _unfulfilledCount_decorators;
    let _unfulfilledCount_initializers = [];
    ...
    return _a = class MainController extends _classSuper {
      constructor() {
        super();
        this.customerId = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _customerId_initializers, void 0));
        this.unfulfilledCount = __runInitializers(this, _unfulfilledCount_initializers, void 0);
        ...
        boardView.appendChild(panel.PanelView, _a.MAIN_PANEL_KEY);
        const urlParams = new URLSearchParams(window.location.search);
        const customerId = urlParams.get("customer") || "";
        this.customerId.set(customerId);
        let host = urlParams.get("host");
        ...
        this.orderListController.attachController(new OrderListController(_a.ORDER_LIST_CONTROLLER_KEY));
      }
      ...
      pickUpAllOrders() {
        var _b, _c;
        Object.values((_c = (_b = this.orderListController.controller) === null || _b === void 0 ? void 0 : _b.series.controllers) !== null && _c !== void 0 ? _c : {}).forEach((controller => {
      ...
      _unfulfilledCount_decorators = [ component.Property({
        valueType: Number,
        value: void 0,
        extends: true,
        binds: true,
        didSetValue(newValue = 0, oldValue) {
          ...
          if (newValue > 0 && (oldValue === void 0 || oldValue === 0) && panelView) {
            ...
            (_b = this.owner.orderListController.controller) === null || _b === void 0 ? void 0 : _b.panel.insertView(panelView, void 0, void 0, MainController.ORDER_LIST_CONTROLLER_KEY).set({
              unitWidth: 1,
              unitHeight: 1
            });
      ...
      _placeOrderFab_decorators = [ view.ViewRef({
        ...
        createView() {
          ...
          (_b = buttonStackView.button.view) === null || _b === void 0 ? void 0 : _b.style.backgroundColor.set(MainController.orderStatusColors[OrderStatus.orderPlaced]);
          buttonStackView.button.attachView().icon.attachView();
          (_c = buttonStackView.button.view) === null || _c === void 0 ? void 0 : _c.icon.push(graphics.VectorIcon.create(24, 24, "M11,13L5,13L5,11L11,11L11,5L13,5L13,11L19,11L19,13L13,13L13,19L11,19Z"), false);
          (_d = buttonStackView.button.view) === null || _d === void 0 ? void 0 : _d.set({
            style: {
              width: "100%",
              height: "100%"
            },
          ...
          (_f = (_e = buttonStackView.button.view) === null || _e === void 0 ? void 0 : _e.icon.view) === null || _f === void 0 ? void 0 : _f.set({
            style: {
          ...
          const c = buttonStackView.appendChild(button.ButtonItem, "c");
          ...
          const cLabel = c.insertChild(dom.HtmlView, null, "label").set({
            style: {
              marginTop: "6px",
              height: "24px",
              lineHeight: "24px",
          ...
          const b = buttonStackView.appendChild(button.ButtonItem, "b");
          if (b.button) {
            b.button.set({
              style: {
                backgroundColor: MainController.orderStatusColors[OrderStatus.orderPlaced],
          ...
          const bLabel = b.insertChild(dom.HtmlView, null, "label").set({
            style: {
              marginTop: "6px",
              height: "24px",
              lineHeight: "24px",
          ...
          const a = buttonStackView.appendChild(button.ButtonItem, "a");
          if (a.button) {
            a.button.set({
              style: {
                backgroundColor: MainController.orderStatusColors[OrderStatus.orderPlaced],
          ...
          const aLabel = a.insertChild(dom.HtmlView, null, "label").set({
            style: {
              marginTop: "4px",
              height: "24px",
              lineHeight: "24px",
      ...
      _pickupOrdersFab_decorators = [ view.ViewRef({
        ...
        createView() {
          ...
          (_b = fab.icon.view) === null || _b === void 0 ? void 0 : _b.set({
            style: {
              transform: math.Transform.parse("scale(1.5,1.5)")
            },
            classList: [ "svg", "black" ]
      ...
      _statusDownlink_decorators = [ client.ValueDownlink({
        ...
        didSet(value) {
          ...
          const newUnfulfilledCount = [ OrderStatus.orderPlaced, OrderStatus.orderProcessed, OrderStatus.readyForPickup ].reduce(((acc, nextStatus) => acc + status[nextStatus].total.count), 0);
      ...
      __esDecorate(null, null, _unfulfilledCount_decorators, {
        kind: "field",
        name: "unfulfilledCount",
        static: false,
        private: false,
        access: {
          has: obj => "unfulfilledCount" in obj,
          get: obj => obj.unfulfilledCount,
          set: (obj, value) => {
            obj.unfulfilledCount = value;
          }
        },
        metadata: _metadata
      }, _unfulfilledCount_initializers, _instanceExtraInitializers);
  ...
  let CustomerController = (() => {
    ...
    return _a = class CustomerController extends _classSuper {
      constructor() {
        var _b;
        super();
        this.customerId = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _customerId_initializers, void 0));
