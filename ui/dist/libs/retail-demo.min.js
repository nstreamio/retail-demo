...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("@nstream/domain"), require("@swim/model"), require("@swim/util"), require("@swim/graphics"), require("@swim/client"), require("@swim/uri"), require("@swim/controller"), require("@swim/panel"), require("@swim/dom"), require("@swim/view"), require("@swim/component"), require("@swim/structure"), require("@swim/theme"), require("@swim/table"), require("@nstream/widget"), require("@swim/math"), require("@swim/style"), require("@swim/time"), require("@swim/chart"), require("@swim/pie")) : typeof define === "function" && define.amd ? define([ "exports", "@nstream/domain", "@swim/model", "@swim/util", "@swim/graphics", "@swim/client", "@swim/uri", "@swim/controller", "@swim/panel", "@swim/dom", "@swim/view", "@swim/component", "@swim/structure", "@swim/theme", "@swim/table", "@nstream/widget", "@swim/math", "@swim/style", "@swim/time", "@swim/chart", "@swim/pie" ], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, 
  factory((global.swim = global.swim || {}, global.swim.retaildemo = global.swim.retaildemo || {}), global.nstream, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.nstream, global.swim, global.swim, global.swim, global.swim, global.swim));
})(this, (function(exports, domain, model, util, graphics, client, uri, controller, panel, dom, view, component, structure, theme, table, widget, math, style, time, chart, pie) {
  "use strict";
  ...
  let OrderAspectTrait = (() => {
    ...
    return _a = class OrderAspectTrait extends _classSuper {
      constructor() {
        super();
  ...
  let OrderEntityTrait = (() => {
    ...
    return _a = class OrderEntityTrait extends _classSuper {
      constructor() {
        super();
  ...
  let OrdersRelationTrait = (() => {
    ...
    return _a = class OrdersRelationTrait extends _classSuper {
      constructor() {
        super();
  ...
  let OrderBoardController = (() => {
    ...
    return _a = class OrderBoardController extends _classSuper {
      constructor() {
        super();
  ...
  let CumulativeOrdersPanelController = (() => {
    ...
    return _a = class CumulativeOrdersPanelController extends _classSuper {
  ...
  let OrderStatusPieController = (() => {
    var _a;
    let _classSuper = widget.TimePieController;
    let _instanceExtraInitializers = [];
    ...
    let _focusedOrderType_decorators;
    let _focusedOrderType_initializers = [];
    let _statusDownlink_decorators;
    let _statusDownlink_initializers = [];
    return _a = class OrderStatusPieController extends _classSuper {
      constructor(orderStatus, headerTitle) {
        ...
        this.focusedOrderType = __runInitializers(this, _focusedOrderType_initializers, void 0);
      ...
      updateSlice(entityStatus, slice, type) {
        ...
        if (!value) {
          ...
          slice.insertView(this.pie.attachView()).set({
            value: value,
            label: value / entityStatus[this.orderStatus].total.value > .2 ? label : ""
          });
        }
      }
    }, (() => {
      ...
      _focusedOrderType_decorators = [ component.Property({
        valueType: String,
        value: "",
        didSetValue(newValue) {
          if (this.owner.orderStatus === OrderStatus.orderPlaced) {
            ...
            }, util.Timing(util.Easing("linear"), 0, 200));
      ...
      __esDecorate(null, null, _focusedOrderType_decorators, {
        kind: "field",
        name: "focusedOrderType",
        static: false,
        private: false,
        access: {
          has: obj => "focusedOrderType" in obj,
          get: obj => obj.focusedOrderType,
          set: (obj, value) => {
            obj.focusedOrderType = value;
          }
        },
        metadata: _metadata
      }, _focusedOrderType_initializers, _instanceExtraInitializers);
    ...
    })(), _a.alertStatus = domain.Status.improving(0, 2.5, 3.5, 4.5, 5), _a.sliceColors = {
  ...
  let KanbanColumnController = (() => {
    var _a;
    let _classSuper = panel.PanelController;
    let _instanceExtraInitializers = [];
    let _focusedOrderType_decorators;
    let _focusedOrderType_initializers = [];
    return _a = class KanbanColumnController extends _classSuper {
      constructor() {
        super();
        this.focusedOrderType = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _focusedOrderType_initializers, void 0));
      }
    }, (() => {
      var _b;
      const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_b = _classSuper[Symbol.metadata]) !== null && _b !== void 0 ? _b : null) : void 0;
  ...
  let OrderTypeChartController = (() => {
    ...
    return _a = class OrderTypeChartController extends _classSuper {
      ...
      _plot_decorators = [ view.ViewRef({
        ...
        initView(seriesPlotView) {
          ...
          seriesPlotView.addEventListener("pointerenter", (() => {
            ...
            kbColumn === null || kbColumn === void 0 ? void 0 : kbColumn.focusedOrderType.setValue(this.owner.orderType);
          }));
          seriesPlotView.addEventListener("pointerleave", (() => {
            const kbColumn = this.owner.getAncestor(KanbanColumnController);
            kbColumn === null || kbColumn === void 0 ? void 0 : kbColumn.focusedOrderType.setValue("");
          }));
        }
      }) ];
  ...
  let CumulativeOrdersSectionController = (() => {
    ...
    let _statusDownlink_decorators;
    let _statusDownlink_initializers = [];
    return _a = class CumulativeOrdersSectionController extends _classSuper {
      constructor() {
        super();
        ...
        didSet(value) {
          ...
          this.owner.forEachChild((function(child) {
            if (Object.getPrototypeOf(child).constructor.name === "CumulativeOrdersPanelController") {
              child.updateDisplay(entityStatus);
            }
          }));
        }
      }) ];
  ...
  let KanbanBoardController = (() => {
    ...
    let _entity_decorators;
    let _entity_initializers = [];
    return _a = class KanbanBoardController extends _classSuper {
      constructor() {
        super();
  ...
  let OrderListController = (() => {
    ...
    let _orderTypeCol_decorators;
    let _orderTypeCol_initializers = [];
    ...
    let _statusDownlink_decorators;
    let _statusDownlink_initializers = [];
    return _a = class OrderListController extends _classSuper {
      constructor(key) {
        super();
        ...
        this.orderTypeCol = __runInitializers(this, _orderTypeCol_initializers, void 0);
      ...
      static parseOrdersStatus(value) {
        ...
        return [ OrderStatus.orderPlaced, OrderStatus.orderProcessed, OrderStatus.readyForPickup, OrderStatus.pickupCompleted ].reduce(((acc, s) => {
          [ OrderType.OrderA, OrderType.OrderB, OrderType.OrderC ].forEach((t => {
            ...
            let value = count * _a.valuePerOrderType[t];
            if (!acc[s]) {
              acc[s] = {
                total: {
                  count: 0,
      ...
      _panel_decorators = [ controller.TraitViewRef({
        ...
        initView(panelView) {
          ...
          (_b = this.owner.chartCanvas.view) === null || _b === void 0 ? void 0 : _b.classList.add("olc-chart-canvas");
      ...
      _orderTypeCol_decorators = [ view.ViewRef({
        viewType: table.ColView,
        viewKey: "order",
        get parentView() {
          return this.owner.header.attachView();
      ...
      __esDecorate(null, null, _orderTypeCol_decorators, {
        kind: "field",
        name: "orderTypeCol",
        static: false,
        private: false,
        access: {
          has: obj => "orderTypeCol" in obj,
          get: obj => obj.orderTypeCol,
          set: (obj, value) => {
            obj.orderTypeCol = value;
          }
        },
        metadata: _metadata
      }, _orderTypeCol_initializers, _instanceExtraInitializers);
  ...
  let OrderController = (() => {
    ...
    let _orderTypeCell_decorators;
    let _orderTypeCell_initializers = [];
    ...
    return _a = class OrderController extends _classSuper {
      constructor(nodeUri, orderStatus, olc) {
        ...
        this.orderTypeCell = __runInitializers(this, _orderTypeCell_initializers, void 0);
      ...
      updateOrder(orderId) {
        const idx = _a.orderStatusProgression.indexOf(this.eventKey);
        const newStatus = _a.orderStatusProgression[idx + 1];
      ...
      _orderTypeCell_decorators = [ view.ViewRef({
        viewType: table.CellView,
        viewKey: "order",
        get parentView() {
          return this.owner.leaf.insertView();
      ...
      _stats_decorators = [ component.Property({
        ...
        didSetValue(value) {
          ...
          const orderTypeCellView = this.owner.orderTypeCell.view;
          if (orderTypeCellView !== null) {
            ...
            orderTypeCellView.modifyMood(theme.Feel.default, moodStatus.moodModifier);
          }
          const timeInProcessingCellView = this.owner.timeInProcessingCell.view;
          if (timeInProcessingCellView !== null) {
            timeInProcessingCellView.content.set(new Date((_e = value.get("timestamp").numberValue()) !== null && _e !== void 0 ? _e : 0).toString());
      ...
      _focusedCustomerId_decorators = [ component.Property({
        ...
        didSetValue(newValue, oldValue) {
          ...
          if (((_b = olc === null || olc === void 0 ? void 0 : olc.nodeUri.value) === null || _b === void 0 ? void 0 : _b.stringValue) !== "/store/main") {
            return;
          }
      ...
      __esDecorate(null, null, _orderTypeCell_decorators, {
        kind: "field",
        name: "orderTypeCell",
        static: false,
        private: false,
        access: {
          has: obj => "orderTypeCell" in obj,
          get: obj => obj.orderTypeCell,
          set: (obj, value) => {
            obj.orderTypeCell = value;
          }
        },
        metadata: _metadata
      }, _orderTypeCell_initializers, _instanceExtraInitializers);
  ...
  let StoreAspectTrait = (() => {
    ...
    let _staticExtraInitializers = [];
    let _static_get_icon_decorators;
    return _a = class StoreAspectTrait extends _classSuper {
      constructor() {
        super();
        this.id.setIntrinsic("portal");
        this.title.setIntrinsic("Portal");
  ...
  let CustomerAspectTrait = (() => {
    ...
    let _staticExtraInitializers = [];
    let _static_get_icon_decorators;
    return _a = class CustomerAspectTrait extends _classSuper {
      constructor() {
        super();
        this.id.setIntrinsic("portal");
        this.title.setIntrinsic("Portal");
  ...
  let CustomerEntityTrait = (() => {
    ...
    return _a = class CustomerEntityTrait extends _classSuper {
      constructor() {
        super();
        this.portal = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _portal_initializers, void 0));
  ...
  let CustomersRelationTrait = (() => {
    ...
    return _a = class CustomersRelationTrait extends _classSuper {
      constructor() {
        super();
        this.entities = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _entities_initializers, void 0));
  ...
  let StoreEntityTrait = (() => {
    ...
    return _a = class StoreEntityTrait extends _classSuper {
      constructor() {
        super();
        this.portal = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _portal_initializers, void 0));
