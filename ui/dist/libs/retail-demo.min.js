...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("@swim/domain"), require("@swim/util"), require("@swim/model"), require("@swim/client"), require("@swim/graphics"), require("@swim/controller"), require("@swim/panel"), require("@swim/uri"), require("@swim/dom"), require("@swim/view"), require("@swim/component"), require("@swim/structure"), require("@swim/theme"), require("@swim/table"), require("@swim/widget"), require("@swim/math"), require("@swim/style"), require("@swim/time"), require("@swim/chart"), require("@swim/pie")) : typeof define === "function" && define.amd ? define([ "exports", "@swim/domain", "@swim/util", "@swim/model", "@swim/client", "@swim/graphics", "@swim/controller", "@swim/panel", "@swim/uri", "@swim/dom", "@swim/view", "@swim/component", "@swim/structure", "@swim/theme", "@swim/table", "@swim/widget", "@swim/math", "@swim/style", "@swim/time", "@swim/chart", "@swim/pie" ], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, 
...
})(this, (function(exports, domain, util, model, client, graphics, controller, panel, uri, dom, view, component, structure, theme, table, widget, math, style, time, chart, pie) {
  "use strict";
  ...
  let CumulativeOrdersPanelController = (() => {
    ...
    let _mainStatusDownlink_decorators;
    let _mainStatusDownlink_initializers = [];
    return _a = class CumulativeOrdersPanelController extends panel.PanelController {
      constructor(orderType, isCumulative = false) {
        ...
        this.mainStatusDownlink = __runInitializers(this, _mainStatusDownlink_initializers, void 0);
      ...
      _mainStatusDownlink_decorators = [ client.ValueDownlink({
      ...
      __esDecorate(null, null, _mainStatusDownlink_decorators, {
        kind: "field",
        name: "mainStatusDownlink",
        static: false,
        private: false,
        access: {
          has: obj => "mainStatusDownlink" in obj,
          get: obj => obj.mainStatusDownlink,
          set: (obj, value) => {
            obj.mainStatusDownlink = value;
          }
        }
      }, _mainStatusDownlink_initializers, _instanceExtraInitializers);
  ...
  let OrderController = (() => {
    ...
    return _a = class OrderController extends widget.TimeSeriesController {
      constructor(nodeUri, orderStatus) {
        super();
    ...
    _a.orderStatusMood = new Map([ [ "orderPlaced", domain.Status.alert() ], [ "orderProcessed", domain.Status.warning() ], [ "readyForPickup", domain.Status.normal() ] ]), 
    _a;
  })();
  ...
  let OrderStatusPieController = (() => {
    ...
    return _a = class OrderStatusPieController extends widget.TimePieController {
      ...
      _aSlice_decorators = [ view.ViewRef({
        ...
        initView(sliceView) {
          sliceView.set({
            sliceColor: theme.Look.accentColor,
      ...
      _cSlice_decorators = [ view.ViewRef({
        ...
        initView(sliceView) {
          sliceView.set({
            sliceColor: theme.Look.focusColor,
            font: "14px sans-serif",
            textColor: theme.Look.backgroundColor,
            innerRadius: 30,
            outerRadius: 80,
    ...
    })(), _a.alertStatus = domain.Status.improving(0, 2.5, 3.5, 4.5, 5), _a;
  })();
