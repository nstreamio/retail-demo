  ...
  let OrderListController = (() => {
    ...
    return _a = class OrderListController extends _classSuper {
      constructor(title) {
        ...
        const customerId = ((_b = /(?<=\/customer\/)[^\s!?\/.*#|]+(?=\/|$|\?)/gm.exec(window.location.href)) !== null && _b !== void 0 ? _b : [ "" ])[0];
    ...
    return _a = class MainController extends _classSuper {
      ...
      _statusDownlink_decorators = [ client.ValueDownlink({
        ...
        didSet(value) {
          ...
          const newInFlightCount = [ OrderStatus.orderPlaced, OrderStatus.orderProcessed, OrderStatus.readyForPickup ].reduce(((acc, nextStatus) => acc + status[nextStatus].total.count), 0);
  ...
  let CustomerController = (() => {
    ...
    return _a = class CustomerController extends _classSuper {
      constructor() {
        ...
        this.customerId.set(customerId);
        this.initBoard();
        (_c = this.mainController.controller) === null || _c === void 0 ? void 0 : _c.sheet.insertView(this.sheet.attachView());
      }
      initBoard() {
