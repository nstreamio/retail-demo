      ...
      _placeOrderFab_decorators = [ view.ViewRef({
        ...
        initView(buttonStackView) {
          buttonStackView.node.addEventListener("click", (() => {
            console.log("buttonStackView.present: ", buttonStackView.presence.present);
            console.log("buttonStackView.presenting: ", buttonStackView.presence.presenting);
            console.log("buttonStackView.presented: ", buttonStackView.presence.presented);
