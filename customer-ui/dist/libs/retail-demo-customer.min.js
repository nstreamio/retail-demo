...
(function(global, factory) {
  ...
  let OrderListController = (() => {
      ...
      _ordersDownlink_decorators = [ client.MapDownlink({
        ...
        didUpdate(nodeUri, value) {
          ...
          if (status === "pickupCompleted") {
            ...
            console.log("shapeCell.content.view?.classList after: ", (_f = shapeCell.content.view) === null || _f === void 0 ? void 0 : _f.classList.toString());
            console.log("shapeCell.content.view?.node.classList after: ", (_g = shapeCell.content.view) === null || _g === void 0 ? void 0 : _g.node.classList.toString());
            ...
            (_h = orderController.row.view) === null || _h === void 0 ? void 0 : _h.set({
              style: {
                height: "72px"
              }
            });
            (_j = orderController.leaf.view) === null || _j === void 0 ? void 0 : _j.set({
              style: {
                height: "40px"
              }
            });
    ...
    })(), _a.orderStatusMood = new Map([ [ "orderPlaced", domain.Status.alert() ], [ "orderProcessed", domain.Status.warning() ], [ "readyForPickup", domain.Status.normal() ], [ "unknown", domain.Status.unknown() ] ]), 
    _a.orderStatusDescription = new Map([ [ "orderPlaced", "Received by store" ], [ "orderProcessed", "Store is processing order" ], [ "readyForPickup", "Order is ready for pickup!" ], [ "unknown", "Unknown status" ] ]), 
    _a;
  })();
  let MainController = (() => {
    var _a;
    ...
    return _a = class MainController extends panel.BoardController {
      ...
      _emptyState_decorators = [ view.ViewRef({
        ...
        createView() {
          ...
          svgContainerView.appendChild(graphics.HtmlIconView, "circle").set({
            graphics: graphics.CircleIcon.create(),
            style: {
              width: "40px",
              height: "40px"
            },
      ...
      _placeOrderFab_decorators = [ view.ViewRef({
        ...
        createView() {
          ...
          const circleLabel = circle.insertChild(dom.HtmlView, null, "label");
          circleLabel.node.innerText = "Order C: $30.00";
          circle.addEventListener("click", handleClick(OrderType.OrderC));
          (_g = circle.button) === null || _g === void 0 ? void 0 : _g.icon.push(graphics.CircleIcon.create(), false);
          (_j = (_h = circle.button) === null || _h === void 0 ? void 0 : _h.icon.view) === null || _j === void 0 ? void 0 : _j.set({
            style: {
              width: "24px",
              height: "24px"
            },
          ...
          (_k = square.button) === null || _k === void 0 ? void 0 : _k.style.backgroundColor.set("#F8D260");
          const squareLabel = square.insertChild(dom.HtmlView, null, "label");
          squareLabel.node.innerText = "Order B: $20.00";
          square.addEventListener("click", handleClick(OrderType.OrderB));
          (_l = square.button) === null || _l === void 0 ? void 0 : _l.icon.push(graphics.VectorIcon.create(24, 24, "M2,2L22,2L22,22L2,22Z"), false);
          const triangle = buttonStackView.appendChild(button.ButtonItem, "triangle");
          (_m = triangle.button) === null || _m === void 0 ? void 0 : _m.style.backgroundColor.set("#F8D260");
          const triangleLabel = triangle.insertChild(dom.HtmlView, null, "label");
          triangleLabel.node.innerText = "Order A: $10.00";
          triangle.addEventListener("click", handleClick(OrderType.OrderA));
          (_o = triangle.button) === null || _o === void 0 ? void 0 : _o.icon.push(graphics.VectorIcon.create(24, 24, "M12,2L22,22L2,22Z"), false);
